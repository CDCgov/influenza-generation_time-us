## empirical_summary_indep.m ###################################################
empirical_summary_indep <- function(beta0, rho, x_A, f_gen, data_struct_augmented) {
  ...
  # Non-trivial possible generation times and times from symptom onset to transmission (TOST)
