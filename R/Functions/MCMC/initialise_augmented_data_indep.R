## initialise_augmented_data_indep.m ###########################################
initialise_augmented_data_indep <- function(data_struct_observed) {
  # Initialise the structure array of augmented data,
  # data_struct_augmented, from the structure array of observed data,
  # data_struct_observed, for the independent transmission and symptoms
  # model
