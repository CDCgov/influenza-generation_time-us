## update_infection_fun_mech.m #################################################
update_infection_fun_mech <- function(theta, data_struct_augmented_old, ll_household_old, ll_household_form, t_i_prop_sd) {
  ...
  r1                        <- runif(no_households)
  update_hosts_in_household <- ceiling(no_infected_in_household * r1)
  ...
  acceptance <- list(
    ...
    symp      = mean(accept_households[update_hosts_in_household <= no_symp_in_household]),
    asymp     = mean(accept_households[update_hosts_in_household > no_symp_in_household])
  )
