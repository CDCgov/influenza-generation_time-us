## figure1_supp4.m #############################################################
figure_post_realized_gt <- function(scn) {
  # library
  ...
  # save figure
  print( name_plot <- paste0("../R/Results-temp/", scn, "/Figures/", "figure_post_realized_gt-ensemble", ".png") )
  ...
  # save figure
  print( name_plot <- paste0("../R/Results-temp/", scn, "/Figures/", "figure_post_realized_gt-mcmc", ".png") )
  ggplot2::ggsave(file = name_plot, plot = p, width = 11, height = 8.5, type = "cairo")
}
